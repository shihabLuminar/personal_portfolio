...
class StaticData {
	...
	static final profile = Profile(
		...
		summary: 'I build high-quality Flutter apps for mobile and web with clean architecture and great UX.',
	...
	static final projects = <Project>[
		Project(
			name: 'Portfolio Web',
			description: 'Responsive Flutter web portfolio showcasing projects and services.',
			technologies: ['Flutter', 'Dart', 'Material 3'],
			repoUrl: 'https://github.com/your-handle/portfolio',
		),
		Project(
			name: 'Task Manager',
			description: 'Cross-platform task manager with offline sync and notifications.',
